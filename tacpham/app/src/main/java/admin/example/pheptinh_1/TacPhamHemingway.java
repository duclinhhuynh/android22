...
public class TacPhamHemingway extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterTacPham(TacPhamHemingway.this, R.layout.activity_item_tacpham,arrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0){
                    ...
                    intent.setClass(TacPhamHemingway.this, TacPhamHemingway.class);
                    startActivity(intent);
                }
                if (i == 1){
                    Intent intent = new Intent();
                    intent.setClass(TacPhamHemingway.this,Tru.class);
                    startActivity(intent);
                }
                if (i == 2){
                    Intent intent = new Intent();
                    intent.setClass(TacPhamHemingway.this,Nhan.class);
                    startActivity(intent);
                }
            }
        });
