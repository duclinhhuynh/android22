...
public class TacPhamToHoai extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new TacPham("Bài thơ cuộc đời", "tập thơ, 1960)",R.drawable.macngon,R.drawable.start));
        ...
        adapter = new AdapterTacPham(TacPhamToHoai.this, R.layout.activity_item_tacpham,arrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0){
                    ...
                    intent.setClass(TacPhamToHoai.this,Tru.class);
