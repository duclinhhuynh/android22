...
public class TacPhamMacNgon extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterTacPham(TacPhamMacNgon.this, R.layout.activity_item_tacpham,arrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0){
                    ...
                    intent.setClass(TacPhamMacNgon.this,Tru.class);
