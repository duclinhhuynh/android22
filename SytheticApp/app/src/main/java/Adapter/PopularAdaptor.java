...
public class PopularAdaptor extends RecyclerView.Adapter<PopularAdaptor.ViewHolder> {
    ...
    holder.title.setText(popularfood.get(holder.getAdapterPosition()).getTitle());
    holder.fee.setText(String.valueOf(popularfood.get(holder.getAdapterPosition()).getFee()));
